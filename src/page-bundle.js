(function() {
	//#region src/browser-v3/injected/aria-snapshot/utils.ts
	const ROLE_MAP = {
		a: "link",
		button: "button",
		iframe: "iframe",
	...
	//#endregion
	//#region src/browser-v3/injected/aria-snapshot/accname.ts
	let _cache;
	let _cacheHidden;
	...
	*/
	...
	//#endregion
	//#region src/browser-v3/injected/aria-snapshot/generate-accessibility-tree.ts
	let _registry = null;
	let _refs = null;
	let _signatureAssigned = null;
	let _refCounter = 0;
	let _visibilityCache = null;
	const ASIDE_REF_SYMBOL = Symbol("aside_ref");
	...
	*/
	...
	function getOrCreateRefId(element, role, name, refPrefix = "") {
		...
		const cached = element[ASIDE_REF_SYMBOL];
	...
	//#endregion
	//#region src/browser-v3/injected/aside-world.ts
	(function setupAsideWorld() {
