...
const bookmark = z.object({ id: z.string().min(1), parentId: z.string().min(1).optional(), index: z.number().int().min(0).optional(), title: z.string(), url: z.string().optional(), dateAdded: finite.min(0).optional(), dateGroupModified: finite.min(0).optional(), unmodifiable: z.string().optional(), type: z.enum(["bookmark", "folder", "url"]).optional() }).strict();
